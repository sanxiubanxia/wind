...
# 处理secrets不存在的情况
try:
    MY_API_KEY = st.secrets.get("MY_API_KEY", "sk-e64f9cf4a2454760aa495e31902d660b")
    MY_BASE_URL = st.secrets.get("MY_BASE_URL", "https://api.deepseek.com")
except Exception:
    # 如果secrets不存在，使用默认值
    MY_API_KEY = "sk-e64f9cf4a2454760aa495e31902d660b"
    MY_BASE_URL = "https://api.deepseek.com"
